...
function mc4wp_lucy_enqueue( $suffix ) {
	...
	// script
	wp_enqueue_script( 'mc4wp-lucy', plugins_url( '/assets/js/script'. $suffix .'.js', __FILE__ ), array( 'mc4wp-admin' ), MC4WP_PREMIUM_VERSION, true );
	...
	// styles
	wp_enqueue_style( 'mc4wp-lucy', plugins_url( '/assets/css/styles.css', __FILE__ ), array(), MC4WP_PREMIUM_VERSION );
}
